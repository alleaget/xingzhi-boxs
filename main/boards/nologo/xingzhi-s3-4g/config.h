...
// GPIO21 与 cube/metal 一致：4G 模组供电使能。勿再交给 ES8311 当 PA（会在探测前拉低导致模组掉电）。
...
#define NETWORK_MODULE_POWER_IN GPIO_NUM_21  // 拉高 4G 供电
...
#define POWER_USB_ADC_CHANNEL   ADC_CHANNEL_0  // USB 插入检测 GPIO1
#define POWER_BARRY_ADC_CHANNEL ADC_CHANNEL_6  // 电池电量检测 GPIO7
