...
#define TAG "XINGZHI_C3_WIFI"

class XINGZHI_C3_WIFI : public WifiBoard {
private:
...
public:
    XINGZHI_C3_WIFI() : boot_button_(BOOT_BUTTON_GPIO) {
        // 把 ESP32-C3 的 VDD SPI 引脚作为普通 GPIO 使用
