...
// UART Events
#define AT_EVENT_DATA_AVAILABLE BIT0
#define AT_EVENT_COMMAND_DONE   BIT1
#define AT_EVENT_COMMAND_ERROR  BIT2
#define AT_EVENT_RI_PIN_INT     BIT3
#define AT_EVENT_FIFO_OVERFLOW  BIT4

// Default Configuration
#define UART_NUM                UART_NUM_1
#define AT_UART_RX_BUFFER_SIZE  4096
...
private:
    ...
    mutable std::mutex urc_mutex_;
    std::mutex dtr_mutex_;
    esp_pm_lock_handle_t pm_lock_;
    esp_pm_lock_handle_t ri_pm_lock_;
    bool ri_pm_lock_acquired_;
